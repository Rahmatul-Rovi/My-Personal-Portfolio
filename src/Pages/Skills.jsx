  ...
  return (
    <section id="skills" className="py-16 bg-base-100 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* কার্ড ছোট করার জন্য grid columns বাড়ানো হয়েছে (sm:grid-cols-3, md:grid-cols-4, lg:grid-cols-6) */}
       <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
  {skillList.map((skill, index) => (
    <div
      key={index}
      // AOS settings update kora hoyeche
      data-aos="fade-up" 
      data-aos-delay={index * 30} // Delay komiye deya hoyeche jate druto load hoy
      data-aos-offset="100" // Screen e ashar sathe sathe load hobe
